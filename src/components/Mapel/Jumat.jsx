	...
	return (
		<>
			<div
				...
				<div className="w-[50%] text-base  font-medium">Pilihan TKJ Bu aam</div>
			...
			<div
				...
				<div className="w-[50%] text-base  font-medium">Teknik Jaringan Pa ichan</div>
				<div className="flex justify-center items-center text-sm">09.40-15.40</div>
			</div>
		</>
	)
}
