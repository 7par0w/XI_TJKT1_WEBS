...
const Schedule = () => {
  ...
  if (currentWeek === 1 || currentWeek === 3) {
    piketGroup = [
      ["Falya", "Rezky", "Ahmad Fadila", "Fiqih Fauzan"],
      ["Razan", "Faiz", "Raka dwi", "Imam malik"],
      ["Ranaz", "Zahrotun", "Tama", "Alif aditya"],
      ["Fatmah", "abizar", "Adji", "Alif airil"],
      ["Rangga", "Adam", "Azfa", "moses"],
    ];
  } else if (currentWeek === 2 || currentWeek === 4) {
    piketGroup = [
      ["Zevanias", "Ayomi", "Arfa", "zidan"],
      ["Fahri Miring", "Riyan", "Husein", "Nabil"],
      ["Very", "Daffa", "Halimah"],
    ];
  }
