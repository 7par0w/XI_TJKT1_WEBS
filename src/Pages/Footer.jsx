					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/7par0w/" class="hover:underline">
										Falya
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/athazhimaa/" class="hover:underline">
										Rezky
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/one.xitjkt/" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
